...
const AboutPage = () => {
  return (
    <div className="lg:px-14 sm:px-8 px-5 min-h-[calc(100vh-64px)] pt-2 bg-white">
      <div className="w-full sm:py-10 py-8">
        ...
        {/* Intro Paragraph */}
        <p className="text-gray-700 text-sm mb-8 xl:w-[60%] lg:w-[70%] sm:w-[80%] w-full whitespace-normal break-words">
          Linklytics simplifies URL shortening for efficient sharing. You can easily generate, manage, and track your shortened links using our intuitive and reliable platform.
        </p>
